...
export const AdminSidebar: React.FC = () => {
  ...
  return (
    <aside
      ...
      } bg-[#070a12] text-slate-300 border-r border-white/10 shrink-0 flex flex-col justify-between hidden md:flex h-[calc(100vh-3.5rem)] sticky top-14 z-30 transition-all duration-300 select-none`}
    >
